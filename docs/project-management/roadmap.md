...
| 当前关键路径 | `S2-01` | 扩展 S1 最小 schemas，建立完整 v1 公共 Contracts |
...
| 系统架构 | 目标架构已完成；S1 Web/Server/Contracts/Tokens、最小运行拓扑与 CI 已实装 | `architecture.md`、`AI_RULES.md`、ADR 0001～0004、S1 skeleton tests、CI run | S2 平台边界 |
