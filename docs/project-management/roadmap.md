...
| 已通过阶段门 | 尚无完整阶段门；`S0-01`～`S0-05`、`S0-07` 已完成 | 完成 S0-06 后关闭 S0，不提前启动 S1 |
| 当前关键路径 | `S0-06 → S1` | 先完成 Provider 可行性决策，再启动脚手架 |
...
| 系统架构 | 已完成目标架构，工具链、运行拓扑与包装交付边界已冻结 | `architecture.md`、`AI_RULES.md`、`docs/adr/0001-toolchain-and-quality.md`、`docs/adr/0002-runtime-topology.md`、`docs/adr/0003-macos-packaging.md` | 完成 Provider 可行性决策后进入脚手架 |
