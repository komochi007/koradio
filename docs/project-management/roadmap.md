...
| 当前关键路径 | `S2-02` | 建立 SQLite、Drizzle、版本化 migration 与首次数据目录 bootstrap |
...
| 系统架构 | 目标架构已完成；S1 Web/Server/Contracts/Tokens、最小运行拓扑与 CI 已实装，S2-01 v1 公共 Contracts 已验证 | `architecture.md`、`AI_RULES.md`、ADR 0001～0004、S1 skeleton tests、S2 contract tests、CI run | S2 数据与安全平台边界 |
