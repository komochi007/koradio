...
> Status: Active engineering law；S1～S6 阶段门、S7-01/02/06/07/08/09、UX-01～UX-31 与 `v1.0.0` 本机正式版已完成；外部分发未获授权
...
- **MUST** 对结构化听歌意图中的显式语言、地区与人声模式、近 10 期精确曲目去重和单期同艺人最多 1 首执行确定性校验；语言/地区/人声约束不得被 Taste 比例或候选不足静默放宽，只有用户明确点名歌曲或艺人时才能覆盖相应去重规则。
