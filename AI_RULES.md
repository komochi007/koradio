...
- **MUST** 按 `docs/adr/0003-macos-packaging.md` 与 `docs/adr/0004-provider-feasibility.md` 使用原生轻量 launcher + bundled Node Local Service + bundled native TTS helper + 外部浏览器 PWA，并为 arm64/x64 生成独立产物；launcher 与 TTS helper 均不得拥有播放或业务事实。
