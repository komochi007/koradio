...
- **UX-28 P0 已实现，待验收**：`ProgramListeningIntent` 新增节奏显著度、注意力等级、风格排除项和探索倾向；柔和/舒缓/平和办公请求会明确约束为克制节奏与低刺激候选，Taste 仅保留特征级探索作用。纯音乐正式器乐候选不再被通用替代版本规则误杀；最近第 4～10 期的同曲、近期艺人与高频艺人会先延后，只在合规候选不足时复用。
