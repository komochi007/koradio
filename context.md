...
- [ADR 0001](docs/adr/0001-toolchain-and-quality.md) 已选定工具链、质量工具、命令族与 CI 基线；这些仍是待 S1 实装的决策，不是当前可运行能力。
...
工具链实现必须遵循 ADR 0001；运行拓扑必须先由 S0-04 显式决策，并同步 README、工程配置和权威文档。
