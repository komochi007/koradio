...
- 当前有产品、流程、架构、视觉规范、原型提示词、参考图，以及开发前视觉资产契约与 `VDA-*` 任务清单。
- 视觉资产制作尚未开始：归一化基线、Light 页面、Figma、HTML 原型和 QA 证据均不存在。
- 尚无 Git 元数据、源码、依赖清单、锁文件、运行脚本和测试配置。
- 当前不可安装、启动、测试或构建。
...
| 开发前视觉资产制作与验收 | [design/assets/README.md](design/assets/README.md)、[design/tasks/visual-assets.md](design/tasks/visual-assets.md) 与 [design/design.md](design/design.md) |
