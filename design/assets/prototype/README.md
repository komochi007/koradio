...
> 当前范围：VDA-01 HTML 原型骨架 + VDA-02 Tokens 与共享组件目录 + VDA-03 异常与 Profile 01–03 + VDA-04 Radio 三态 04–06 + VDA-05 Detail Sheet 07–08 + VDA-06 Library 09 + 已验收的尺度与核心体验确认门
>
...
- `variant`：仅在页面族定义了固定视觉变体时出现；Library 09 支持 `results`、`importing`、`empty`、`no-results`、`service-error`。
...
- 01–03 已由 VDA-03、04–06 已由 VDA-04、07–08 已由 VDA-05、09 已由 VDA-06 建立 Dark HTML 视觉页面；Library 的五种固定变体已通过自动检查与用户视觉验收，10–15 仍是 VDA-01 定位占位。
