...
| 07 | Detail Sheet：DJ 串讲 | `x 0 / y 0 / w 960 / h 1600` 全屏沉浸节目界面；浅色节目面内 `x 80 / w 800` | `● SPEAKING NOW`；无底部导航 | 顶部 `84 × 6px` 拖动条、`64 × 64px` 关闭按钮、全宽声波区、纯白节目面、节目标题、`If · Bread`、歌曲进度、`800 × 560px` 串讲词卡片、节目整体进度、单一播放/暂停 |
