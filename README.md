...
- [ ] UX-28 P0 节目听感、纯音乐与探索范围优化待验收：结构化意图新增节奏显著度、注意力等级、风格排除项与探索倾向；柔和/舒缓等抽象需求在 Planner 中成为候选约束，Taste 退回特征级探索指导；纯音乐正式器乐候选不再被通用替代版本过滤误杀；第 4～10 期同曲和高频艺人优先避重、候选不足才回退复用。
